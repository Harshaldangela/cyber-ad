...
app = FastAPI(title="Final Improved Hybrid Cyber Awareness Ad API")
...
async def test_detection(req: GenerateRequest):
    ...
    try:
        ...
        hybrid_prediction, hybrid_confidence = final_improved_hybrid_spam_detection(req.text)
...
# Run with: uvicorn final_improved_hybrid_api:app --reload --port 8002